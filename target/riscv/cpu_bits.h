...
#define HMTE_MASK           (HMTE_U_PM_ENABLE | HMTE_U_PM_CURRENT | HMTE_S_PM_ENABLE | HMTE_S_PM_CURRENT | HMTE_H_PM_ENABLE | HMTE_H_PM_CURRENT)
...
#define SMTE_MASK           (SMTE_U_PM_ENABLE | SMTE_U_PM_CURRENT | SMTE_S_PM_ENABLE | SMTE_S_PM_CURRENT)
